        ...
        {currentOrg && (isOrgOwner || isOrgAdmin) && (
          <div className="card p-6">
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-dark-500 mb-4">Your logo and company details appear in all outgoing emails (invites, timesheets, notifications).</p>
              ...
              <div className="flex items-start gap-4 mb-5">
                <button
                  ...
                  className="relative w-24 h-24 rounded-xl border-2 border-dashed border-dark-600 hover:border-rivvra-500/50 bg-dark-800/50 flex items-center justify-center transition-colors overflow-hidden flex-shrink-0 group"
                >
                  {uploadingLogo ? (
              ...
              <div className="space-y-3">
                <div>
                  <label className="block text-xs text-dark-500 mb-1">Company Website</label>
                ...
                <div>
                  <label className="block text-xs text-dark-500 mb-1">Company Address</label>
                ...
                <div>
                  <label className="block text-xs text-dark-500 mb-1">Company Phone</label>
                  <div className="flex items-center gap-3 px-4 py-2.5 bg-dark-800/50 border border-dark-700 rounded-xl">
              ...
              <div className="mt-4">
                ...
                >
                  {savingBranding ? <Loader2 className="w-4 h-4 animate-spin" /> : brandingSaved ? <><Check className="w-4 h-4" /> Saved</> : 'Save Branding'}
                </button>
              </div>
            </div>
