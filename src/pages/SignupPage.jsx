          ...
          {currentStep === STEPS.AUTH && (
            <div className="space-y-6">
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3 px-4 bg-dark-800 hover:bg-dark-700 border border-dark-700 rounded-xl font-medium text-white transition-colors flex items-center justify-center gap-3"
              >
